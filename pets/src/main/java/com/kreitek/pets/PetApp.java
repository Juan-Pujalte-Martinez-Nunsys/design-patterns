...
import com.kreitek.pets.util.logging.Logger;
import com.kreitek.pets.util.logging.LoggerFactory;

import java.util.Scanner;

public class PetApp {

    private static final Logger logger = LoggerFactory.getConsoleLogger();
